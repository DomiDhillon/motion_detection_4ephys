...
- Quantify rodent movement from camera recording 
- Manual selection of frame coordiantes for rats
- Real time plots
- Synchronize with ephys neural recording time using .npy output from Basler camera
<br>
...
- clone this repo<br>
```
git clone https://github.com/DomiDhillon/motion_detection_4ephys.git
```
<br>
...
+ applied in notebooks named 'Processing_Movement_*'<br>
    + in the example below, <code>w628</code> is a path to folder where the (symlink) video and csv of the session are stored. 
...
![image_tuto](https://user-images.githubusercontent.com/65451658/215339443-d57b64de-53fa-4bcc-9685-131eb154f1d4.png)
